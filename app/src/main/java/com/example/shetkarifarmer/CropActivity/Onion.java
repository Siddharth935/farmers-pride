...
import com.example.shetkarifarmer.databinding.ActivityOnionBinding;
...
public class Onion extends AppCompatActivity {
    ...
    private final int REQUEST_CODE = 203;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.selectCropImage.setOnClickListener(v -> Dexter.withActivity(Onion.this).withPermissions(Manifest.permission.READ_EXTERNAL_STORAGE).withListener(new MultiplePermissionsListener() {
            @Override
...
//                    Toast.makeText(Onion.this, "Enter Your Crop Name", Toast.LENGTH_SHORT).show();
//                else if (binding.Rate.getEditableText().toString().isEmpty())
//                    Toast.makeText(Onion.this, "Enter Your Rate", Toast.LENGTH_SHORT).show();
//                else if (binding.farmerName.getText().toString().isEmpty())
//                    Toast.makeText(Onion.this, "Enter Your Name", Toast.LENGTH_SHORT).show();
//                else if (binding.farmerMobileNumber.getText().toString().isEmpty())
//                    Toast.makeText(Onion.this, "Enter Your MobileNumber", Toast.LENGTH_SHORT).show();
//                else if (binding.CropKG.getEditableText().toString().isEmpty())
//                    Toast.makeText(Onion.this, "Enter Your Crop KG", Toast.LENGTH_SHORT).show();
...
//        });
    ...
    private void upload() {
        ...
        storageReference = storage.getReference("Onion").child(""+farmerMobileNumber);
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        reference = rootNode.getReference("AllVegetable").child("Onion").child("" + farmerMobileNumber);
                        ...
                        referenceTwo.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Onion").setValue(vegatbleModel);
                    }
                });
            }
