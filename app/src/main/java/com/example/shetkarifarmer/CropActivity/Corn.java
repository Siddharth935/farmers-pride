...
public class Corn extends AppCompatActivity {
    ...
    private ActivityCornBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCornBinding.inflate(getLayoutInflater());
        ...
        binding.selectCropImage.setOnClickListener(v -> Dexter.withActivity(Corn.this).withPermissions(Manifest.permission.READ_EXTERNAL_STORAGE).withListener(new MultiplePermissionsListener() {
            @Override
...
//                Intent intent = new Intent(Intent.ACTION_PICK);
    ...
    private void upload() {
        ...
        storageReference = storage.getReference("Corn").child("" + farmerMobileNumber);
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        reference = rootNode.getReference("AllVegetable").child("Corn").child("" + farmerMobileNumber);
                        ...
                        referenceTwo.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Corn").setValue(vegatbleModel);
                    }
                });
            }
