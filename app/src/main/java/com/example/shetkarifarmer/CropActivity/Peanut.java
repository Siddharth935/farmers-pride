...
import com.example.shetkarifarmer.databinding.ActivityPeanutBinding;
...
public class Peanut extends AppCompatActivity {

    private ActivityPeanutBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPeanutBinding.inflate(getLayoutInflater());
        ...
        binding.selectCropImage.setOnClickListener(v -> Dexter.withActivity(Peanut.this).withPermissions(Manifest.permission.READ_EXTERNAL_STORAGE).withListener(new MultiplePermissionsListener() {
            @Override
...
//                Intent intent = new Intent(Intent.ACTION_PICK);
    ...
    private void upload() {
        ...
        storageReference = storage.getReference("Peanut").child(""+farmerMobileNumber);
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        reference = rootNode.getReference("AllVegetable").child("Peanut").child("" + farmerMobileNumber);
                        ...
                        referenceTwo.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Peanut").setValue(vegatbleModel);
                    }
                });
            }
