...
import com.example.shetkarifarmer.databinding.ActivityGingerBinding;
...
public class Ginger extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.selectCropImage.setOnClickListener(v -> Dexter.withActivity(Ginger.this).withPermissions(Manifest.permission.READ_EXTERNAL_STORAGE).withListener(new MultiplePermissionsListener() {
            @Override
...
//                Intent intent = new Intent(Intent.ACTION_PICK);
    ...
    private void upload() {
        ...
        storageReference = storage.getReference("Ginger").child("" + farmerMobileNumber);
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        reference = rootNode.getReference("AllVegetable").child("Ginger").child("" + farmerMobileNumber);
                        ...
                        referenceTwo.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Ginger").setValue(vegatbleModel);
                    }
                });
            }
