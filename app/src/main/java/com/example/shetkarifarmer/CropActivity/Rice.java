...
import com.example.shetkarifarmer.databinding.ActivityRiceBinding;
...
public class Rice extends AppCompatActivity {
    ...
    private final int REQUEST_CODE = 206;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.selectCropImage.setOnClickListener(v -> Dexter.withActivity(Rice.this).withPermissions(Manifest.permission.READ_EXTERNAL_STORAGE).withListener(new MultiplePermissionsListener() {
            @Override
...
//                Intent intent = new Intent(Intent.ACTION_PICK);
    ...
    private void upload() {
        ...
        storageReference = storage.getReference("Rice").child(""+farmerMobileNumber);
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        reference = rootNode.getReference("AllVegetable").child("Rice").child("" + farmerMobileNumber);
                        ...
                        referenceTwo.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Rice").setValue(vegatbleModel);
                    }
                });
            }
