...
import com.example.shetkarifarmer.databinding.ActivityFullNewsBinding;
...
public class FullNews extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.fullScreenDateAndDay.setText(getIntent().getStringExtra("DateAndDay").toString());
