...
public class MarathiNews extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_marathi_news, container, false);
        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.marathiNewsRecycler);
//        progressBar = view.findViewById(R.id.marathiNewsProgress);
        reference = FirebaseDatabase.getInstance().getReference("MarathiNews");
